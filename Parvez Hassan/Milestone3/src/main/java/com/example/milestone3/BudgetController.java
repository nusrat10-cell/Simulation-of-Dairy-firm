...
//            Amount of each catagory
                ...
                // Hardcoded file path
                String filePath = "C:/BudgetData/budgetData.txt"; // Modify this path as needed
...
//                        writer.write(item.getName() + "," + item.getAllocation() + "," + item.getAmount() + "\n");
                    ...
                    System.out.println("Budget data saved to: " + filePath);
                    showError("Budget data saved to: " + filePath);
                } catch (IOException e) {
